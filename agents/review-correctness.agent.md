...
description: Independently challenge consequential PR behavior and contracts using reachable counterexamples. Return technical candidates from pinned evidence without editing.
tools: ["read", "search"]
---
